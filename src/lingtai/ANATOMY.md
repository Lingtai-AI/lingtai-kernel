...
Parent: `src/lingtai/` under `lingtai-kernel/src/` alongside `lingtai/kernel/` (kernel package) and the top-level `tools/` package (concrete built-in tools; see `../tools/ANATOMY.md`). Siblings: `llm/`, `services/`, `auth/`. See `../ANATOMY.md`.
