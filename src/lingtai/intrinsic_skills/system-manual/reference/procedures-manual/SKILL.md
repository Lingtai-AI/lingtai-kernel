...
summaries the fresh replay may still omit historical timely transient `_meta` copies
from already-sent tool results without rewriting recorded history. Every 1.0 forced rebuild
