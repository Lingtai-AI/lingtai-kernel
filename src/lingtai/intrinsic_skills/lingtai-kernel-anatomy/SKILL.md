...
- **Cross-references between anatomies use kernel-root-relative paths.** `src/lingtai/tools/soul/ANATOMY.md`, not `./ANATOMY.md` or `intrinsics/soul/ANATOMY.md`. The root is the only stable reference frame.
