...
schema validated by :func:`lingtai.services.mcp_inbox.validate_event`.
...
from .mcp_inbox import EVENT_SUFFIX, INBOX_DIRNAME, LICC_VERSION, TMP_SUFFIX, validate_event
