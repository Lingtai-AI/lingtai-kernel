...
**Native helper crate:** `src/lingtai/native/search_sidecar/` (Rust) — opt-in binary that backs `RustFileIOBackend`. Not required for install/tests.
