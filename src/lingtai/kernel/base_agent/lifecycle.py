...
def _perform_refresh(
    ...
    *,
    ...
    relaunch_script = (
        ...
        "def _is_verified_refresh_host(pid):\n"
        "    try:\n"
        "        from lingtai.tools.daemon.refresh_host import is_verified_refresh_host as _f\n"
        "        return _f(pid, wd)\n"
        "    except Exception:\n"
        "        return False\n"
        ...
        "        return False\n"
        "    if _is_verified_refresh_host(pid):\n"
        "        log('refresh_watcher_skipped_verified_refresh_host', attempt=attempt, pid=pid)\n"
        "        failure_state['last_cleanup_result'] = 'skipped_verified_refresh_host'\n"
        "        return False\n"
        "    age = heartbeat_age()\n"
