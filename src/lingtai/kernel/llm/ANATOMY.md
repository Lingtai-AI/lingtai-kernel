...
- `lingtai/tools/psyche/` and `lingtai/tools/soul/` use canonical blocks/interfaces for molt replay and soul-flow consultation (`src/lingtai/tools/psyche/_molt.py:14`, `src/lingtai/tools/soul/inquiry.py:16`, `src/lingtai/tools/soul/consultation.py:223`, `src/lingtai/tools/soul/consultation.py:454`, `src/lingtai/tools/soul/consultation.py:594`).
