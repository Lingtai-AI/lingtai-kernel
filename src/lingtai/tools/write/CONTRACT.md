...
implementation lives in `src/lingtai/tools/write/__init__.py`; the code is the source of
truth.
...
**Do not use this for:**
- Surgical in-place replacement: read `src/lingtai/tools/edit/CONTRACT.md`.
- Reading content back: read `src/lingtai/tools/read/CONTRACT.md`.
