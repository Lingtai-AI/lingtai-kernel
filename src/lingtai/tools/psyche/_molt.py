...
# reminders live at ``_meta.agent_meta.agent_state.context.molt`` (meta_block.
...
def _context_molt(agent, args: dict) -> dict:
    ...
    if hasattr(agent, "_notification_persistent_wechat_message_ids"):
        agent._notification_persistent_wechat_message_ids = []
    if hasattr(agent, "_notification_persistent_wechat_last_tool_id"):
        agent._notification_persistent_wechat_last_tool_id = None
    if hasattr(agent, "_notification_persistent_feishu_message_ids"):
        agent._notification_persistent_feishu_message_ids = []
    if hasattr(agent, "_notification_persistent_feishu_last_tool_id"):
        agent._notification_persistent_feishu_last_tool_id = None
