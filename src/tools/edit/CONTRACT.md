...
lives in `src/tools/edit/__init__.py`; the code is the source of truth.
...
**Do not use this for:**
- Full-file replacement or new files: read `src/tools/write/CONTRACT.md`.
- Reading content: read `src/tools/read/CONTRACT.md`.
...
| Claim | Source `src/tools/edit/...` | Test |
|---|---|---|
...
| `file` sugar registers edit alongside the other four file tools | `src/tools/registry.py` | `tests/test_layers_file.py::test_file_sugar_expands_to_five` |
