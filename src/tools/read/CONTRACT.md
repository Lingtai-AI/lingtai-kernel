...
The implementation lives in `src/tools/read/__init__.py`; the code is the source
of truth.
...
**Do not use this for:**
- Writing / mutating files: read `src/tools/write/CONTRACT.md` or
  `src/tools/edit/CONTRACT.md`.
- Recursive discovery / search: read `src/tools/glob/CONTRACT.md` or
  `src/tools/grep/CONTRACT.md`.
...
| Claim | Source `src/tools/read/...` | Test |
|---|---|---|
