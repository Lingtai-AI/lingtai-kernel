...
def _parent_host_tool_floor() -> frozenset[str]:
    ...
    """
    from tools.registry import CORE_DEFAULTS  # noqa: PLC0415
...
class DaemonManager:
    ...
    def _expand_requested_tools(self, requested: list[str]) -> set[str]:
        ...
        from tools.registry import _GROUPS
    ...
    def _instantiate_preset_capabilities(
        ...
        """
        from tools.registry import setup_capability, _GROUPS, BUILTIN_TOOLS
