...
def _check_context_fits(agent, preset_name: str) -> tuple:
    ...
    """
    from lingtai_kernel.presets import load_preset, preset_context_limit
...
def _presets(agent, args: dict) -> dict:
    ...
    """
    import json
    from lingtai_kernel.presets import load_preset, resolve_allowed_presets, home_shortened
