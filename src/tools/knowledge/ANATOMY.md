...
related_files:
  ...
  - src/tools/knowledge/CONTRACT.md
...
- `tools.registry` maps builtin capability name `knowledge` here. Former
...
- For the stable behavior contract, read `src/tools/knowledge/CONTRACT.md`
