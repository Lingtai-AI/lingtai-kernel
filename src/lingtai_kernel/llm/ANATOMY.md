...
- `tools/psyche/` and `tools/soul/` use canonical blocks/interfaces for molt replay and soul-flow consultation (`src/tools/psyche/_molt.py:14`, `src/tools/soul/inquiry.py:16`, `src/tools/soul/consultation.py:223`, `src/tools/soul/consultation.py:454`, `src/tools/soul/consultation.py:594`).
