...
# NOTE (SDK-02): translation strings for the file tools still live in
# ``lingtai.i18n`` (keys like ``read.description``). The SDK imports them by
# absolute path for now; owning these strings in the SDK is a follow-up.
