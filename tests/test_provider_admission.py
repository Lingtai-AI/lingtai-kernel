...
def test_provider_dispatch_concurrency_inventory_is_explicit():
    ...
    outside_root_provider_dispatch = {
        ...
        ("src/lingtai/adapters/browser_transport.py", 56, "Thread"),
            ("src/lingtai/adapters/posix/daemon_manager.py", 341, "Thread"),
            ("src/lingtai/adapters/posix/daemon_manager.py", 564, "Thread"),
        ...
        ("src/lingtai/services/mcp_inbox.py", 606, "Thread"),
            ...
            ("src/lingtai/tools/daemon/__init__.py", 6547, "Thread"),
            ("src/lingtai/tools/daemon/__init__.py", 9151, "ThreadPoolExecutor"),
        ("src/lingtai/tools/daemon/claude_interactive.py", 611, "Thread"),
            ("src/lingtai/tools/daemon/execution_host.py", 616, "ThreadPoolExecutor"),
