...
def test_terminal_async_daemon_dispatch_rejects_non_emanate_or_invalid_shape():
    cases = [
        ...
        (ToolCall(name="daemon", args={"action": "emanate"}, id="empty-id-string"),
         {"status": "dispatched", "ids": [""], "group_id": "dg-1", "terminal_async_dispatch": True}),
        (ToolCall(name="daemon", args={"action": "emanate"}, id="non-string-id"),
         {"status": "dispatched", "ids": [1], "group_id": "dg-1", "terminal_async_dispatch": True}),
        (ToolCall(name="daemon", args={"action": "emanate"}, id="missing-group"),
         {"status": "dispatched", "ids": ["em-1"], "terminal_async_dispatch": True}),
        (ToolCall(name="daemon", args={"action": "emanate"}, id="non-string-group"),
         {"status": "dispatched", "ids": ["em-1"], "group_id": 1, "terminal_async_dispatch": True}),
