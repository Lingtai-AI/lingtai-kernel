...
def test_public_export_and_exact_production_opt_ins():
    ...
    expected_official = {"avatar", "daemon", "email", "mcp", "notification", "plugin", "psyche", "shell", "soul", "system", "task_card", "vision", "web"}
    ...
    assert expected_curated | expected_official == {
        "avatar", "cloud_mail", "daemon", "email", "feishu", "imap", "mcp", "notification", "plugin", "psyche", "shell", "soul", "system", "task_card", "telegram", "vision", "web", "wechat", "whatsapp"
    }
